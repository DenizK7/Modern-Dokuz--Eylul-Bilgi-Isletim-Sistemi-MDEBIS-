...
/*!50001 DROP VIEW IF EXISTS `department_head`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `department_head` AS SELECT 
 1 AS `Department_Id`,
...
--
-- Dumping events for database 'mdebis'
--

--
-- Dumping routines for database 'mdebis'
--
/*!50003 DROP PROCEDURE IF EXISTS `lecturer_get_password` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `lecturer_get_password`(out Password_out varchar(1000),In Lecturer_Id_inp INT)
BEGIN
SELECT Password INTO Password_out from mdebis.lecturer where Lecturer_Id=Lecturer_Id_inp ;
END ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `manager_get_password` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `manager_get_password`(In Manager_Id_inp INT)
BEGIN
set @Password_out = '';
SELECT Password Password_out from mdebis.manager where Manager_Id=Manager_Id_inp;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `student_get_password` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `student_get_password`(In Student_Id_inp INT)
BEGIN
set @Password_out = '';
SELECT Password Password_out from mdebis.student where Student_Id=Student_Id_inp;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2022-12-20 23:04:28
